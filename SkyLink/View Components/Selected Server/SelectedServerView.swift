...
class SelectedServerView: UIView {
    ...
    private func setupUI() {
        backgroundColor = DesignSystem.AppColors.cardBackgroundColor
        layer.cornerRadius = 10
        layer.shadowColor = DesignSystem.AppColors.shadowColor.cgColor
        ...
        chevronImageView.tintColor = DesignSystem.AppColors.primaryColor
